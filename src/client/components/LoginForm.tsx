...
export default function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="animate-[fadeIn_0.3s_ease]">
      <h1 className="text-2xl font-bold text-text-primary mb-1">Entrar</h1>
      <p className="text-text-secondary text-sm mb-6">Acesse sua conta Forja</p>
      ...
      <p className="mt-2 text-center text-sm text-text-secondary">
        Não tem uma conta?{' '}
        <a href="/auth/register" className="text-molten-500 hover:text-molten-400 transition-colors font-medium">Cadastrar</a>
      </p>
    </form>
  )
}
